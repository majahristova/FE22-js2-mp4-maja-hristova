class Calculator {
  previousOperstorText: HTMLElement;
  currentOperatorText: HTMLElement;
  operation: string | undefined;
  currentOperand:string = '';
  previousOperand:string = '';

  constructor(previousOperstorText: HTMLElement, currentOperatorText: HTMLElement) {
  ...
  choseOperation(operation: string) {
